...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 17 sep. 2020 à 16:21
...
(102, 'HONORE DE BALZAC', 'Le Pére Goriot'),
...
ALTER TABLE `emprunt`
  ...
  ADD CONSTRAINT `emprunt_ibfk_3` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`),
  ADD CONSTRAINT `emprunt_ibfk_4` FOREIGN KEY (`id_abonne`) REFERENCES `abonne` (`id_abonne`);
COMMIT;
